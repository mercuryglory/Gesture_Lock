 ...
 * 描述:      ${TODO}
 */
public class GestureContent extends ViewGroup {
    ...
    public GestureContent(Context context, boolean isVerify,
                              String passWord, GestureLine.GestureCallBack callBack) {
        super(context);
        // 获取屏幕宽度
        ...
        addChild();
        // 初始化一个可以画线的view
        gestureDrawline = new GestureLine(context, list, isVerify,
                passWord, callBack);
    }
